                    ...
                    <div className="flex gap-2 hover:cursor-pointer">
                        <div className="flex items-center justify-center">
                            <div className="relative inline-block">
                                ...
                                {/* Dropdown menu */}
                                <div className={`absolute right-0 z-20 w-48 py-2 mt-2 bg-white dark:bg-zinc-700 rounded-md shadow-xl ${dropdown ? '' : 'hidden'} `} onMouseLeave={() => setDropdown(false)}>
                                    <ThemeButton setTheme={setTheme} setDropdown={setDropdown}/>
                                    <span className="dark:text-white dark:hover:bg-zinc-600 px-4 py-3 text-sm  capitalize transition-colors duration-200 transform hover:bg-gray-100 flex gap-1">
                                        ...
                                        </svg><span >Profile não funciona </span>
                                    </span>
                                    <span className="px-4 py-3 text-sm text-red-500 capitalize dark:hover:bg-zinc-600 transition-colors duration-200 transform hover:bg-gray-100 flex gap-1" onClick={logout}>
