        ...
        <div className='shadow-lg flex rounded-md bg-purple-600 text-white overflow-hidden min-h-[207px]' data-aos="fade-up" >
            ...
            <div className='flex flex-col gap-2 w-full text-center'>
                ...
                <div className="flex mt-auto">
                    ...
                    <Link to={`/${_id}/edit`} className={`bg-[#ffa200] hover:bg-[#ffb000] px-4 py-2 font-semibold cursor-pointer flex justify-center gap-2 ${name === createdBy.id ? '' : 'hidden'}`}>
