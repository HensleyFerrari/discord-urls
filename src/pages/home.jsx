    ...
    <>
      ...
      <div className='container mx-auto mt-5 mb-5'>
        <div className="flex mb-5 gap-5 pl-5 pr-5 sm:p-0">
          ...
          <input type="text" value={searchTerm} placeholder='Quero escutar... (filtro pelo nome da música)' className='w-full outline outline-offset-1 outline-purple-500 rounded-md p-2' onChange={e => { setSearchTerm(e.target.value) }} />
